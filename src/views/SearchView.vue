...
<template>
    <div class="p-8">
        ...
        <div class="grid xl:grid-cols-5 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 gap-6">
            ...
            <CategorySelect category="On Repeat" image="https://picsum.photos/id/25/300/300"/>
            <CategorySelect category="Podcasts" image="https://picsum.photos/id/103/300/300"/>
            <CategorySelect category="Audiobooks" image="https://picsum.photos/id/88/300/300"/>
            <CategorySelect category="Made For You" image="https://picsum.photos/id/42/300/300"/>
            <CategorySelect category="New Release" image="https://picsum.photos/id/235/300/300"/>
            <CategorySelect category="On Repeat" image="https://picsum.photos/id/241/300/300"/>
            <CategorySelect category="Podcasts" image="https://picsum.photos/id/255/300/300"/>
            <CategorySelect category="Audiobooks" image="https://picsum.photos/id/45/300/300"/>
            <CategorySelect category="Made For You" image="https://picsum.photos/id/76/300/300"/>
            <CategorySelect category="New Release" image="https://picsum.photos/id/56/300/300"/>
            <CategorySelect category="On Repeat" image="https://picsum.photos/id/25/300/300"/>
