...
const {isPlaying, currentSong, currentAlbum, album, songs } = storeToRefs(useSong)

const playFunc = () => {
    if(currentSong.value) {
        useSong.playOrPauseThisSong(currentAlbum.value, currentSong.value)
        return
    }
...
<template>
    <div class="p-8 overflow-x-hidden">
        ...
        <div class="flex items-center w-full relative h-full">
            <img width="140" :src="album.album_cover">
            ...
            <div class="w-full ml-5">
                ...
                <div class="text-gray-300 text-[13px] flex">
                    ...
                    <div class="ml-2 flex">
                        ...
                        <span class="-ml-0.5">{{ album.year }}</span>
                    </div>
                    <div class="ml-2 flex">
                        <div class="circle mt-2 mr-2"></div>
        ...
        <div class="mb-4"></div>
        <ul class="w-full" v-for="song, index in songs" :key="song">
            <SongRow :album="album" :song="song" :index="++index"/>
        </ul>
    </div>
</template>
